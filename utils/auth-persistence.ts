...
export const saveAuthState = async (user: User | null): Promise<void> => {
  try {
    ...
    debugError('[AuthPersistence] Failed to save auth state:', _error);
  }
};
...
export const loadAuthState = async (): Promise<PersistedAuthState | null> => {
  try {
    ...
    debugError('[AuthPersistence] Failed to load auth state:', _error);
    return null;
  }
};
...
export const loadSavedUserInfo = async (): Promise<SavedUserInfo | null> => {
  try {
    ...
    debugError('[AuthPersistence] Failed to load user info:', _error);
    return null;
  }
};
...
export const loadSavedAuthToken = async (): Promise<string | null> => {
  try {
    ...
    debugError('[AuthPersistence] Failed to load auth token:', _error);
    return null;
  }
};
...
export const clearAuthState = async (): Promise<void> => {
  try {
    ...
    debugError('[AuthPersistence] Failed to clear auth data:', _error);
  }
};
...
export const updateLastLoginTime = async (): Promise<void> => {
  try {
    ...
    debugError('[AuthPersistence] Failed to update last login time:', _error);
  }
};
...
export const getAuthPersistenceStats = async () => {
  try {
    ...
    debugError('[AuthPersistence] Failed to get stats:', _error);
    return {
      hasAuthState: false,
