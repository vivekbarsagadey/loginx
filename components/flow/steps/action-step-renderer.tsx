      ...
      case 'error':
        return (
          <>
            ...
            {step.retry?.enabled && (!step.retry.maxAttempts || retryCount < step.retry.maxAttempts) && <ThemedButton title="Retry" onPress={handleRetry} variant="secondary" leftIcon="refresh" style={styles.retryButton} />}
